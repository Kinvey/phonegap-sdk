...
var _middleware = require('kinvey-html5-sdk/dist/middleware');
...
var PhoneGapHttpMiddleware = function (_HttpMiddleware) {
  _inherits(PhoneGapHttpMiddleware, _HttpMiddleware);

  function PhoneGapHttpMiddleware() {
    _classCallCheck(this, PhoneGapHttpMiddleware);

    return _possibleConstructorReturn(this, (PhoneGapHttpMiddleware.__proto__ || Object.getPrototypeOf(PhoneGapHttpMiddleware)).apply(this, arguments));
  }
